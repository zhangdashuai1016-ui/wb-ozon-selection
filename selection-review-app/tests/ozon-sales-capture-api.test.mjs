...
test("one Ozon capture appends a verified SalesSnapshot without changing business state", async (t) => {
  ...
  assert.deepEqual(busyState.captureControl, { status: "idle", label: "商品采集控制空闲", candidateId: null,
    captureId: null, platform: null, captureKind: null, startedAt: null, expiresAt: null });
