...
test("SoftwareJob admission Schema与运行时strictRef、resultEnvelope和waiting_platform同源", async () => {
  ...
  assert.deepEqual(jobSchema.properties.jobType.enum, ["ozon_account_read", "c2_stable_asset_transport", "c1_paid_keyword_evidence", "c1_ai_draft", "d_production_execution", "e_independent_readback", "e_d_platform_observation"]);
  ...
  assert.deepEqual(admissionSchema.$defs.softwareJobAuthorizationRecord.oneOf.map((branch) => branch.$ref), [
    "a-discovery-v1.schema.json#/$defs/authorization",
    "a-discovery-v2.schema.json#/$defs/authorization",
    "a-product-detail-v1.schema.json#/$defs/authorization",
    "ozon-account-read-v1.schema.json#/$defs/authorization",
    "#/$defs/c2StableAssetTransportAuthorizationRecord",
    "#/$defs/c1PaidKeywordEvidenceAuthorizationRecord",
    "#/$defs/c1AiDraftAuthorizationRecord",
    "a-supplier-image-search-v1.schema.json#/$defs/authorization"
  ]);
  assert.equal(
