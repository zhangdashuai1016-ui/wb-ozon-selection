...
import { addSyntheticLicensedRightsToCheckedFixture } from "./c1-sku-rights-review-fixture.mjs";
...
export function keywordPlanningCandidate(overrides = {}) {
  ...
  const c1ProductPlan = {
    ...
    inputSnapshots: { salesSnapshot: sales, confirmedSupplierSkuSnapshot: supply, profitModel: profit,
      platformSchemaRules: { evidenceId: "schema:music-box", platform: "ozon", store: "dandanshu", requiredFields: [] } },
  ...
  const candidate = {
    ...
    lifecycleV11: {
      skuPackage: {
        g1Identity: {
      schemaVersion: "g1-identity-v1", candidateId: "CX-MUSIC-BOX-014", skuPackageId: c1ProductPlan.identity.skuPackageId,
      platform: "ozon", storeRef: { stableStoreId: "dandanshu", platformStoreId: "synthetic-seller-001", mappingVersion: "synthetic-v1" },
      supplierSkuId: "MUSIC-WHITE", merchantSku: "not_applicable", warehouseRef: "not_applicable",
  ...
  addSyntheticLicensedRightsToCheckedFixture(candidate.lifecycleV11.skuPackage, { sourceSkuRevision: 8, reviewedAt: KEYWORD_NOW });
  return candidate;
}
