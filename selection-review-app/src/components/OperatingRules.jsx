  ...
  return (
    <section className="operating-rules" aria-label="今日确认的选品与防空跑规则">
      ...
      <div className="rule-grid">
        ...
        <p><strong>成本口径</strong>采购到手总价=货价+国内运费；只有总价的历史记录不倒推组成，未知运费不显示成0。促销20%/25%/30%只反推建议标价，不作为广告成本从折后成交价二次扣除。</p>
        <p><strong>利润门槛</strong>单件利润≥20 RMB，或利润率≥15%，满足任一项即可；中国跨境卖家优先但不唯一，证据完整且商品可比的身份未确认样本也可正常进入A/B。</p>
